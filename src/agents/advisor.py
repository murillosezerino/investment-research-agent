...
ADVISOR_PROMPT = ChatPromptTemplate.from_messages([
    (
        ...
        "Research summary:\n{research}\n\n"
        "Risk analysis:\n{analysis}\n\n"
        "Relevant conclusions from earlier research sessions (long-term memory — "
        "use for consistency, but the current research takes precedence and may "
        "supersede outdated conclusions):\n{prior_context}\n\n"
